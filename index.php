            ...
            <div class="card-body pad">
              <div class="mb-3">
                <?php
						...
						if($p=='wilayah') include 'wilayah.php';
						else
						if($p=='pegawai') include 'pegawai.php';
						else
						if($p=='tindakan') include 'tindakan.php';
						else
						if($p=='obat') include 'obat.php';
						else
						if($p=='pasien') include 'pasien.php';
						else
						if($p=='form_tindakan') include 'form_tindakan.php';
						else
						if($p=='informasi') include 'informasi.php';
						else
						if($p=='laporan') include 'grafikbar.php';
						else
